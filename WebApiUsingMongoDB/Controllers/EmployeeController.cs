...
using WebApiUsingMongoDB.Models;

namespace WebApiUsingMongoDB.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        public JsonResult Put(Employee dep)
        {
            ...
            var update = Builders<Employee>.Update.Set("EmployeeName", dep.EmployeeName)
                                                  .Set("Department", dep.Department)
                                                  .Set("DateOfJoining", dep.DateOfJoining)
                                                  .Set("PhotoFileName", dep.PhotoFileName);
